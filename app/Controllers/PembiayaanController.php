...
class PembiayaanController extends BaseController
{
    ...
    public function tambah()
    {
        ...
        $data = [
            ...
            'sppd' => $model1->getSppd()->getResultArray(),
            'kode' => $kodepembiayaan
        ];
    ...
    public function update($id)
    {
        ...
        $data = [
            ...
            'sppd' => $model4->getSppd()->getResultArray()
        ];
    ...
    public function save()
    {
        ...
        if ($this->validate($rules)) {
            ...
            $data = array(
                ...
                'pembiayaanSppd' => $this->request->getPost('sppd'),
            ...
            $validation = \Config\Services::validation();
            return redirect()->to('/spj/tambah')->withInput()->with('validation', $validation);
        }
    }
