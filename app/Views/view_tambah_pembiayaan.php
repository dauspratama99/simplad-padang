...
<div class="container">
    <div class="card">
        ...
        <form action="<?= base_url('spj/save'); ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            <div class="card-body">
                    ...
                    <div class="col-sm-5">
                        <div class="form-group">
                            <div class="form-group">
                                <label>SPPD</label>
                                <div class="input-group mb-3">
                                    <input type="text" id="sppd" name="sppd" required readonly class="form-control sppd" />
                                    <button class="btn btn-primary ml-1" data-toggle="modal" data-target="#searchSppd" type="button">Cari</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-10">
                        <div class="float-right">
                            <a href="<?= base_url('spj'); ?>" class="btn btn-secondary">Kembali</a>
                        ...
                        foreach ($keberangkatan as $row) : $no++ ?>
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <a class="btn-sm btn-info btn-choose1" data-keberangkatan="<?= $row['keberangkatanKode']; ?>" data-spt="<?= $row['sptKode']; ?>"><i class="fa fa-edit"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
...
<div class="modal" tabindex="-1" id="searchSppd">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                    ...
                    <tbody>
                        ...
                        foreach ($sppd as $row) : $no++ ?>
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <a class="btn-sm btn-info btn-choose2" data-kode="<?= $row['sppdKode']; ?>"><i class="fa fa-edit"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
